        ...
        protected override IQueryable<SnagReport> CreateFilteredQuery(PagedSnagReportResultRequestDto input)
        {
            return Repository.GetAll()
                .WhereIf(!input.Keyword.IsNullOrWhiteSpace(), x =>
                    ...
                    (x.ReportedBy != null && x.ReportedBy.Contains(input.Keyword)) ||
                ...
                .WhereIf(!input.ReportedBy.IsNullOrWhiteSpace(), x => x.ReportedBy != null && x.ReportedBy.Contains(input.ReportedBy))
                ...
                .WhereIf(input.AtaChapterId.HasValue, x => x.AtaChapterId == input.AtaChapterId.Value)
