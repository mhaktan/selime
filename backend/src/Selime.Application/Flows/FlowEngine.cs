                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = Type.GetType("Selime.Approvals.IApprovalAppService, Selime.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in Selime.Application assembly");
                            ...
                            var submitInputType = Type.GetType("Selime.Approvals.Dto.SubmitApprovalInput, Selime.Application")!;
