...
{
    [DependsOn(typeof(SelimeCoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class SelimeEntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<SelimeDbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SelimeEntityFrameworkCoreModule).GetAssembly());
        }
    }
}
