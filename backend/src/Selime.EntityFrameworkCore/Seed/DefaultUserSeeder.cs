...
namespace Selime.EntityFrameworkCore.Seed
{
    /// <summary>
    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "LineMechanic", DisplayName = "Line Mechanic", Description = "Hat bakım teknisyeni — snag raporlar, inceleme yapar ve CRS adımına iletir", IsSystem = false, IsActive = true };
                ...
                var customPerms_0 = new[] { "SnagReport.Read", "SnagReport.Create", "SnagReport.Update", "SnagReport.ChangeStatus", "Aircraft.Read", "AtaChapter.Read", "Station.Read", "PartCatalog.Read", "SnagReportPart.Read", "SnagReportPart.Create", "SnagReportPart.Update", "SnagReportPart.Delete" };
                ...
                {
                    customRole_1 = new AppRole { Name = "CertifyingStaff", DisplayName = "Certifying Staff", Description = "Sertifikalı personel — CRS (Certificate of Release to Service) düzenler, snag'i kapatır ya da mekaniğe iade eder", IsSystem = false, IsActive = true };
                ...
                var customPerms_1 = new[] { "SnagReport.Read", "SnagReport.Create", "SnagReport.Update", "SnagReport.Delete", "SnagReport.ChangeStatus", "Aircraft.Read", "AtaChapter.Read", "Station.Read", "PartCatalog.Read", "SnagReportPart.Read" };
