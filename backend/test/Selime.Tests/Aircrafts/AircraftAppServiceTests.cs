...
namespace Selime.Tests.Aircrafts
{
    public class AircraftAppServiceTests
    {
        ...
        public void Repository_GetAll_ShouldReturnQueryable()
        {
            ...
            var entities = new[]
            {
                new Aircraft { Id = 1, Registration = "Test registration", ManufacturingYear = 1, Status = 0 },
                new Aircraft { Id = 2, Registration = "Test registration", ManufacturingYear = 1, Status = 0 },
            }.AsQueryable();
        ...
        public async Task Create_ShouldInsertEntity()
        {
            ...
            {
                Registration = "Test registration", ManufacturingYear = 1, Status = 0
            };

            _repositoryMock.Setup(r => r.InsertAndGetIdAsync(It.IsAny<Aircraft>()))
                .ReturnsAsync(1);
            _repositoryMock.Setup(r => r.GetAsync(It.IsAny<long>()))
                .ReturnsAsync(new Aircraft { Id = 1, Registration = "Test registration", ManufacturingYear = 1, Status = 0 });
