...
import { SnagReportPartList } from './SnagReportPartList';
...
describe('SnagReportPartList', () => {
  it('should render without crashing', () => {
    const { container } = render(<SnagReportPartList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<SnagReportPartList />, { wrapper });
    expect(screen.getByText('SnagReportPart')).toBeDefined();
  });

  it('should have create button', () => {
    render(<SnagReportPartList />, { wrapper });
    expect(screen.getByText('+ Create SnagReportPart')).toBeDefined();
  });
