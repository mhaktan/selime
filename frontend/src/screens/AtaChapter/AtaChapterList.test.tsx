...
import { AtaChapterList } from './AtaChapterList';
...
describe('AtaChapterList', () => {
  it('should render without crashing', () => {
    const { container } = render(<AtaChapterList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<AtaChapterList />, { wrapper });
    expect(screen.getByText('AtaChapter')).toBeDefined();
  });

  it('should have create button', () => {
    render(<AtaChapterList />, { wrapper });
    expect(screen.getByText('+ Create AtaChapter')).toBeDefined();
  });
