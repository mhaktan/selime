...
import { AircraftTypeList } from './AircraftTypeList';
...
describe('AircraftTypeList', () => {
  it('should render without crashing', () => {
    const { container } = render(<AircraftTypeList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<AircraftTypeList />, { wrapper });
    expect(screen.getByText('AircraftType')).toBeDefined();
  });

  it('should have create button', () => {
    render(<AircraftTypeList />, { wrapper });
    expect(screen.getByText('+ Create AircraftType')).toBeDefined();
  });
