        ...
        <form onSubmit={(e) => { e.preventDefault(); mutation.mutate(form); }} style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
          <div style={{ flex: 1, overflowY: 'auto', padding: '20px 28px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <div>
                  <TkInput mode="text" label="Reported By *" value={String(form.reportedBy ?? '')} onTkChange={(e: CustomEvent) => ((v) => setField('reportedBy', v))(e.detail)} />
                </div>
                <div>
                ...
                <div>
                  <LookupSelect label="ATA Chapter *" resource="AtaChapter" value={String(form.ataChapterId ?? '')} onChange={(v) => setField('ataChapterId', v)} />
                </div>
                <div>
