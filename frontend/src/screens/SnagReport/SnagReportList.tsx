...
const COLUMNS: TableColumn[] = [
  ...
  { field: 'reportedBy', header: 'Reported By', sortable: true, searchable: true, filterType: 'text' },
  ...
  { field: 'ataChapterId', header: 'ATA Chapter', sortable: true },
  { field: 'stationId', header: 'Station', sortable: true },
];
