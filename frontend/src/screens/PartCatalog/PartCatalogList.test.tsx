...
import { PartCatalogList } from './PartCatalogList';
...
describe('PartCatalogList', () => {
  it('should render without crashing', () => {
    const { container } = render(<PartCatalogList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<PartCatalogList />, { wrapper });
    expect(screen.getByText('PartCatalog')).toBeDefined();
  });

  it('should have create button', () => {
    render(<PartCatalogList />, { wrapper });
    expect(screen.getByText('+ Create PartCatalog')).toBeDefined();
  });
